...
{
	{
		...
		// offset = 4;
		__this->___offset_1 = 4;
		// alignmentCorrection = -4;
		__this->___alignmentCorrection_2 = ((int32_t)-4);
		// }
		return;
	}
}
...
{
	{
		...
		int32_t L_3 = __this->___alignmentCorrection_2;
		int32_t L_4 = ___dataSize0;
		int32_t L_5 = ___dataSize0;
		__this->___offset_1 = ((int32_t)il2cpp_codegen_add(L_0, ((int32_t)(((int32_t)il2cpp_codegen_subtract(L_1, ((int32_t)(((int32_t)il2cpp_codegen_add(L_2, L_3))%L_4))))&((int32_t)il2cpp_codegen_subtract(L_5, 1))))));
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MessageDeserializer_Read_m82B22DA76582918DC2FF9771977798BDBF5D49D7 (MessageDeserializer_tB7A06A4B097DD01A2E35E9AFEB085164A41603FF* __this, String_t** ___value0, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	{
		...
		NullCheck(L_2);
		String_t* L_6;
		L_6 = VirtualFuncInvoker3< String_t*, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(44 /* System.String System.Text.Encoding::GetString(System.Byte[],System.Int32,System.Int32) */, L_2, L_3, L_4, ((int32_t)il2cpp_codegen_subtract(L_5, 1)));
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MessageSerializer_SerializeMessage_mC4CE2BF559DBB25D23A5894B617BD917B1622549 (MessageSerializer_tF85A77B0C9BAB7548B9EC879E5E651CEACA95AF7* __this, Message_tBD8A361BD6D49D4FF433A098AE3E5EE758F160FF* ___message0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* L_0 = ((MessageSerializer_tF85A77B0C9BAB7548B9EC879E5E651CEACA95AF7_StaticFields*)il2cpp_codegen_static_fields_for(MessageSerializer_tF85A77B0C9BAB7548B9EC879E5E651CEACA95AF7_il2cpp_TypeInfo_var))->___k_Ros2Header_0;
		...
		__this->___m_LengthCorrection_4 = ((int32_t)il2cpp_codegen_add(L_1, L_2));
		// m_AlignmentOffset = 0; // header doesn't affect alignment
		__this->___m_AlignmentOffset_3 = 0;
		// message.SerializeTo(this);
		Message_tBD8A361BD6D49D4FF433A098AE3E5EE758F160FF* L_3 = ___message0;
		NullCheck(L_3);
		VirtualActionInvoker1< MessageSerializer_tF85A77B0C9BAB7548B9EC879E5E651CEACA95AF7* >::Invoke(4 /* System.Void Unity.Robotics.ROSTCPConnector.MessageGeneration.Message::SerializeTo(Unity.Robotics.ROSTCPConnector.MessageGeneration.MessageSerializer) */, L_3, __this);
		// }
		return;
	}
}
...
IL_000e_1:
			{
				...
				NullCheck(L_5);
				NullCheck(L_3);
				VirtualActionInvoker3< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(32 /* System.Void System.IO.Stream::Write(System.Byte[],System.Int32,System.Int32) */, L_3, L_4, 0, ((int32_t)(((RuntimeArray*)L_5)->max_length)));
			}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MessageSerializer_Align_mA0937D1D85F64B0E995AC382913D4D1FA0DC0B14 (MessageSerializer_tF85A77B0C9BAB7548B9EC879E5E651CEACA95AF7* __this, int32_t ___dataSize0, const RuntimeMethod* method) 
{
	...
	int32_t V_0 = 0;
	{
		...
		int32_t L_2 = ___dataSize0;
		int32_t L_3 = ___dataSize0;
	...
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(MessageSerializer_tF85A77B0C9BAB7548B9EC879E5E651CEACA95AF7_il2cpp_TypeInfo_var);
		ByteU5BU5DU5BU5D_t19A0C6D66F22DF673E9CDB37DEF566FE0EC947FA* L_6 = ((MessageSerializer_tF85A77B0C9BAB7548B9EC879E5E651CEACA95AF7_StaticFields*)il2cpp_codegen_static_fields_for(MessageSerializer_tF85A77B0C9BAB7548B9EC879E5E651CEACA95AF7_il2cpp_TypeInfo_var))->___k_PaddingBytes_2;
		int32_t L_7 = V_0;
		NullCheck(L_6);
		int32_t L_8 = L_7;
...
IL_0025:
	{
		...
		int32_t L_10 = __this->___m_AlignmentOffset_3;
		int32_t L_11 = V_0;
		__this->___m_AlignmentOffset_3 = ((int32_t)il2cpp_codegen_add(L_10, L_11));
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MessageSerializer_Write_m312F6ADF2C641C9B93F4E1FC7D416F60034C9B1C (MessageSerializer_tF85A77B0C9BAB7548B9EC879E5E651CEACA95AF7* __this, String_t* ___inputString0, const RuntimeMethod* method) 
{
	...
	ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* V_0 = NULL;
	{
		...
		L_5 = BitConverter_GetBytes_m343FFC3DD8CF8D0139D0CAEB8ABB0A4D6DAA98F4(((int32_t)il2cpp_codegen_add(((int32_t)(((RuntimeArray*)L_4)->max_length)), 1)), NULL);
		NullCheck(L_3);
		...
		List_1_tBFF9DD9FFA06F20E74F9D7AD36610BD754D353A4* L_8 = __this->___m_ListOfSerializations_5;
		il2cpp_codegen_runtime_class_init_inline(MessageSerializer_tF85A77B0C9BAB7548B9EC879E5E651CEACA95AF7_il2cpp_TypeInfo_var);
		ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* L_9 = ((MessageSerializer_tF85A77B0C9BAB7548B9EC879E5E651CEACA95AF7_StaticFields*)il2cpp_codegen_static_fields_for(MessageSerializer_tF85A77B0C9BAB7548B9EC879E5E651CEACA95AF7_il2cpp_TypeInfo_var))->___k_NullByte_1;
		NullCheck(L_8);
		...
		NullCheck(L_11);
		__this->___m_AlignmentOffset_3 = ((int32_t)il2cpp_codegen_add(L_10, ((int32_t)il2cpp_codegen_add(((int32_t)il2cpp_codegen_add(4, ((int32_t)(((RuntimeArray*)L_11)->max_length)))), 1))));
		// }
		return;
	}
}
